...
<body>
    ...
    <main>
            ...
            <ul class="nav nav-tabs" role="tablist">
                ...
                <li class="nav-item">
                    <a class="nav-link" data-bs-target="#Itineraires" data-bs-target="#Comptes" data-bs-toggle="tab" type="button" role="tab" aria-selected="false">Itinéraires</a>
                </li>
                <li class="nav-item">
            ...
            <div class="tab-content">
                <div class="tab-pane fade show active" id="Circuits">
                    <div class="entete">
